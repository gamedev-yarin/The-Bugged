...
במשחק יהיה דמות אחת והיא של השחקן.
במשחק לא יהיה דמויות משניות. הדמות לא תשתנה במהלך המשחק. לשחקן תהייה שליטה מלאה על דמותו ולכן לדמות הראשית יהיה רצון חופשי.


במשחק יהיו שלוש דמויות:
הדמות הראשית - השחקן. לשחקן תהייה שליטה מלאה על הדמות.
דמות משנית הבומנים - הדמות לא נמצאת פיזית במשחק אלה מספרת את הסיפור ומנהלת את מהלך המשחק.
דמות משנית - ההקרים לא נמצאת פיזית למשחק אלה תורמת לקושי השלבים ולהתקדמות הסיפור.

הדמות המרכזית היא לא הגיבורה של הסיפור היא דמות שנקלעה לסיפור.
ההקרים הם במתנגדים של הבוחנים
